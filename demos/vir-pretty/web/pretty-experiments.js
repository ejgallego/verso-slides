...
(function () {
    ...
    config.experiments = [
        ...
        {
            id: "vir-html-residency",
            label: "VIR HTML residency",
            question:
                "What changes when complete HTML uses a package-resident Format and annotations instead of transferring them on every call?",
            backends: ["vir-html", "vir-resident-html"],
            design: "controlled",
            variable: "Input residency: transferred Format + annotations ↔ package-resident ID",
            controls: [
                "VIR runtime",
                "prettyM and HTML renderer",
                "complete escaped HTML output",
                "column budget",
                "final populated DOM",
            ],
            measures: "Input marshal, execute, decode, committed total, and retained package cost.",
        },
        {
            id: "all",
            label: "All backends",
