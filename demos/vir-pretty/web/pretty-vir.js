...
(function () {
    ...
    bridge.residentHtmlExportName =
        config.residentHtmlExportName ||
        bridge.residentHtmlExportName ||
        "VersoSlides.PrettyRegistry.formatHtmlByIdForVir";
    ...
    bridge.ready = runtimeReady
        .then(function (runtimeValue) {
            ...
            bridge.formatHtmlById = function (formatId, width, indent) {
                return runtime.call(
                    /** @type {string} */ (bridge.residentHtmlExportName),
                    formatId,
                    width,
                    indent,
                );
            ...
            if (runtime.callTimed) {
                ...
                bridge.formatHtmlByIdTimed = function (formatId, width, indent) {
                    return callTimed(
                        /** @type {string} */ (bridge.residentHtmlExportName),
                        formatId,
                        width,
